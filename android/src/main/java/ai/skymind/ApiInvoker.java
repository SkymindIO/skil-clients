...
import ai.skymind.auth.Authentication;
import ai.skymind.auth.ApiKeyAuth;
import ai.skymind.auth.HttpBasicAuth;
import ai.skymind.request.GetRequest;
import ai.skymind.request.PostRequest;
import ai.skymind.request.PutRequest;
import ai.skymind.request.DeleteRequest;
import ai.skymind.request.PatchRequest;
...
public class ApiInvoker {
  ...
  */
  ...
  public static void initializeInstance(Cache cache, Network network, int threadPoolSize, ResponseDelivery delivery, int connectionTimeout) {
    ...
    setUserAgent("OpenAPI-Generator/1.2.2.0/android");

    // Setup authentications (key: authentication name, value: authentication).
    INSTANCE.authentications = new HashMap<String, Authentication>();
    INSTANCE.authentications.put("api_key", new ApiKeyAuth("header", "authorization"));
    INSTANCE.authentications.put("x_api_key", new ApiKeyAuth("header", "X-API-Key"));
