...
import ai.skymind.skil.client.model.AuthPolicy;
...
import ai.skymind.skil.client.model.BatchRecord;
import ai.skymind.skil.client.model.BestModel;
import ai.skymind.skil.client.model.ChangePasswordRequest;
...
import ai.skymind.skil.client.model.FeedbackResponse;
...
import ai.skymind.skil.client.model.RetrainingStatus;
import ai.skymind.skil.client.model.RevisionsWritten;
import ai.skymind.skil.client.model.Role;
import ai.skymind.skil.client.model.RollbackStatus;
...
import ai.skymind.skil.client.model.TokenGenerateRequest;
import ai.skymind.skil.client.model.UpdateBestModel;
import ai.skymind.skil.client.model.User;
...
public class DefaultApi extends SwaggerApi {
    ...
    */
    public function DefaultApi(apiCredentials: ApiUserCredentials, eventDispatcher: EventDispatcher = null) {
        ...
        public static const event_accumulated_results: String = "accumulated_results";
        ...
        public static const event_add_feedback_binary: String = "add_feedback_binary";
        public static const event_add_feedback_json: String = "add_feedback_json";
        ...
        public static const event_change_user_password: String = "change_user_password";
        ...
        public static const event_clear_state: String = "clear_state";
        ...
        public static const event_generate_auth_token: String = "generate_auth_token";
        public static const event_get_all_jobs: String = "get_all_jobs";
        public static const event_get_array: String = "get_array";
        public static const event_get_array_indices: String = "get_array_indices";
        public static const event_get_array_range: String = "get_array_range";
        public static const event_get_auth_policy: String = "get_auth_policy";
        ...
        public static const event_get_current_model: String = "get_current_model";
        ...
        public static const event_get_user_auth_tokens: String = "get_user_auth_tokens";
        public static const event_get_users: String = "get_users";
        public static const event_is_training: String = "is_training";
        ...
        public static const event_num_revisions: String = "num_revisions";
        public static const event_predict: String = "predict";
        public static const event_predict_error: String = "predict_error";
        public static const event_predict_v2_file: String = "predict_v2_file";
        public static const event_predict_v2_json: String = "predict_v2_json";
        ...
        public static const event_raw_predict_binary: String = "raw_predict_binary";
        ...
        public static const event_revoke_user_token: String = "revoke_user_token";
        public static const event_rollback: String = "rollback";
        ...
        public static const event_update_auth_policy: String = "update_auth_policy";
    ...
    /*
     * Returns AccumulatedResults 
     */
    public function accumulated_results (): String {
        // create path and map variables
        var path: String = "/accumulatedresults".replace(/{format}/g,"xml");
        ...
        token.completionEventType = "accumulated_results";

        token.returnType = AccumulatedResults;
        return requestId;
     ...
     */
    public function add_feedback_binary (id: String, type: String, file: File): String {
        // create path and map variables
        var path: String = "/feedback/{id}/{type}".replace(/{format}/g,"xml").replace("{" + "id" + "}", getApiInvoker().escapeString(id)).replace("{" + "type" + "}", getApiInvoker().escapeString(type));
        ...
        token.requestId = requestId;
        token.completionEventType = "add_feedback_binary";

        token.returnType = FeedbackResponse;
        return requestId;
     ...
     * Returns FeedbackResponse 
     */
    public function add_feedback_json (id: String, labels: Array): String {
        // create path and map variables
        var path: String = "/feedback/{id}/json".replace(/{format}/g,"xml").replace("{" + "id" + "}", getApiInvoker().escapeString(id));
        ...
        var token:AsyncToken = getApiInvoker().invokeAPI(path, "POST", queryParams, labels, headerParams);

        var requestId: String = getUniqueId();

        token.requestId = requestId;
        token.completionEventType = "add_feedback_json";
     ...
     * Returns User 
     */
    public function change_user_password (userId: String, changePasswordRequest: ChangePasswordRequest): String {
        // create path and map variables
        var path: String = "/user/{userId}/password".replace(/{format}/g,"xml").replace("{" + "userId" + "}", getApiInvoker().escapeString(userId));
        ...
        var token:AsyncToken = getApiInvoker().invokeAPI(path, "POST", queryParams, changePasswordRequest, headerParams);

        var requestId: String = getUniqueId();

        token.requestId = requestId;
        token.completionEventType = "change_user_password";
    ...
    public function clear_state (): String {
        // create path and map variables
        var path: String = "/clear".replace(/{format}/g,"xml");
        ...
        token.requestId = requestId;
        token.completionEventType = "clear_state";
     ...
     * Returns Token 
     */
    public function generate_auth_token (tokenGenerateRequest: TokenGenerateRequest): String {
        // create path and map variables
        var path: String = "/auth/token".replace(/{format}/g,"xml");
        ...
        var token:AsyncToken = getApiInvoker().invokeAPI(path, "POST", queryParams, tokenGenerateRequest, headerParams);

        var requestId: String = getUniqueId();

        token.requestId = requestId;
        token.completionEventType = "generate_auth_token";
     ...
     * Returns void 
     */
    public function get_array (accept: String, arrayType: String): String {
        // create path and map variables
        var path: String = "/array/{arrayType}".replace(/{format}/g,"xml").replace("{" + "arrayType" + "}", getApiInvoker().escapeString(arrayType));
        ...
        token.requestId = requestId;
        token.completionEventType = "get_array";
     ...
     * Returns void 
     */
    public function get_array_indices (contentType: String, accept: String, arrayType: String, input: String): String {
        // create path and map variables
        var path: String = "/array/indices/{arrayType}".replace(/{format}/g,"xml").replace("{" + "arrayType" + "}", getApiInvoker().escapeString(arrayType));
...
headerParams["accept"] = toPathValue(accept);
        ...
        var token:AsyncToken = getApiInvoker().invokeAPI(path, "POST", queryParams, input, headerParams);

        var requestId: String = getUniqueId();

        token.requestId = requestId;
        token.completionEventType = "get_array_indices";
     ...
     * Returns void 
     */
    public function get_array_range (accept: String, arrayType: String, from: Number, to: Number): String {
        // create path and map variables
        var path: String = "/array/range/{from}/{to}/{arrayType}".replace(/{format}/g,"xml").replace("{" + "arrayType" + "}", getApiInvoker().escapeString(arrayType)).replace("{" + "from" + "}", getApiInvoker().escapeString(from)).replace("{" + "to" + "}", getApiInvoker().escapeString(to));
        ...
        token.requestId = requestId;
        token.completionEventType = "get_array_range";
     ...
     * Returns AuthPolicy 
     */
    public function get_auth_policy (): String {
        // create path and map variables
        var path: String = "/auth/policy".replace(/{format}/g,"xml");
        ...
        token.requestId = requestId;
        token.completionEventType = "get_auth_policy";

        token.returnType = AuthPolicy;
        return requestId;
    ...
    public function get_current_model (): String {
        ...
        token.requestId = requestId;
        token.completionEventType = "get_current_model";
     ...
     * Returns EvaluationResultsEntity 
     */
    public function get_last_evaluation (): String {
        // create path and map variables
        var path: String = "/lastevaluation".replace(/{format}/g,"xml");
        ...
        token.requestId = requestId;
        token.completionEventType = "get_last_evaluation";
    ...
    public function get_roles (): String {
        // create path and map variables
        var path: String = "/security/roles".replace(/{format}/g,"xml");
     ...
     * Returns User 
     */
    public function get_user (userId: String): String {
        // create path and map variables
        var path: String = "/user/{userId}".replace(/{format}/g,"xml").replace("{" + "userId" + "}", getApiInvoker().escapeString(userId));
     ...
     * Returns Array 
     */
    public function get_user_auth_tokens (userId: String, onlyValid: Boolean): String {
        // create path and map variables
        var path: String = "/auth/{userId}/tokens".replace(/{format}/g,"xml").replace("{" + "userId" + "}", getApiInvoker().escapeString(userId));
        ...
        if("null" != String(onlyValid))
            queryParams["onlyValid"] = toPathValue(onlyValid);
        ...
        token.requestId = requestId;
        token.completionEventType = "get_user_auth_tokens";
    ...
    public function get_users (): String {
        // create path and map variables
        var path: String = "/security/users".replace(/{format}/g,"xml");
    ...
    /*
     * Returns RetrainingStatus 
     */
    public function is_training (): String {
        // create path and map variables
        var path: String = "/istraining".replace(/{format}/g,"xml");
        ...
        token.requestId = requestId;
        token.completionEventType = "is_training";

        token.returnType = RetrainingStatus;
        return requestId;
    ...
    public function login (loginRequest: LoginRequest): String {
        ...
        var token:AsyncToken = getApiInvoker().invokeAPI(path, "POST", queryParams, loginRequest, headerParams);
        ...
        token.returnType = LoginResponse;
        return requestId;
     ...
     * Returns LogBatch 
     */
    public function logs (deploymentName: String, versionName: String, modelName: String, logRequest: LogRequest): String {
        // create path and map variables
        ...
        var token:AsyncToken = getApiInvoker().invokeAPI(path, "POST", queryParams, logRequest, headerParams);
    ...
    /*
     * Returns RevisionsWritten 
     */
    public function num_revisions (): String {
        // create path and map variables
        var path: String = "/numrevisions".replace(/{format}/g,"xml");
        ...
        token.requestId = requestId;
        token.completionEventType = "num_revisions";

        token.returnType = RevisionsWritten;
        return requestId;
     ...
     * Returns void 
     */
    public function predict_error (contentType: String, operation: String, inputType: String, inputData: String): String {
        // create path and map variables
        var path: String = "/{operation}/{inputType}/error".replace(/{format}/g,"xml").replace("{" + "operation" + "}", getApiInvoker().escapeString(operation)).replace("{" + "inputType" + "}", getApiInvoker().escapeString(inputType));
        ...
        var token:AsyncToken = getApiInvoker().invokeAPI(path, "POST", queryParams, inputData, headerParams);

        var requestId: String = getUniqueId();

        token.requestId = requestId;
        token.completionEventType = "predict_error";
     ...
     * Returns void 
     */
    public function predict_v2_file (operation: String, inputTypeFile: String, inputData: File): String {
        // create path and map variables
        var path: String = "/{operation}/{inputTypeFile}".replace(/{format}/g,"xml").replace("{" + "operation" + "}", getApiInvoker().escapeString(operation)).replace("{" + "inputTypeFile" + "}", getApiInvoker().escapeString(inputTypeFile));
        ...
        token.requestId = requestId;
        token.completionEventType = "predict_v2_file";
     ...
     * Returns void 
     */
    public function predict_v2_json (contentType: String, operation: String, inputTypeJson: String, inputData: String): String {
        // create path and map variables
        var path: String = "/{operation}/{inputTypeJson}".replace(/{format}/g,"xml").replace("{" + "operation" + "}", getApiInvoker().escapeString(operation)).replace("{" + "inputTypeJson" + "}", getApiInvoker().escapeString(inputTypeJson));
        ...
        token.requestId = requestId;
        token.completionEventType = "predict_v2_json";
     ...
     * Returns void 
     */
    public function raw_predict_binary (inputType: String, outputType: String, inputData: File): String {
        // create path and map variables
        var path: String = "/raw/{inputType}/{outputType}".replace(/{format}/g,"xml").replace("{" + "inputType" + "}", getApiInvoker().escapeString(inputType)).replace("{" + "outputType" + "}", getApiInvoker().escapeString(outputType));
        ...
        token.requestId = requestId;
        token.completionEventType = "raw_predict_binary";
     ...
     * Returns User 
     */
    public function register_user (user: User): String {
        // create path and map variables
        var path: String = "/user/register".replace(/{format}/g,"xml");
     ...
     * Returns Token 
     */
    public function revoke_user_token (tokenId: Number): String {
        // create path and map variables
        var path: String = "/auth/token/{tokenId}".replace(/{format}/g,"xml").replace("{" + "tokenId" + "}", getApiInvoker().escapeString(tokenId));
        ...
        token.requestId = requestId;
        token.completionEventType = "revoke_user_token";
     ...
     */
    public function rollback (index: Number): String {
        // create path and map variables
        var path: String = "/rollback/{index}".replace(/{format}/g,"xml").replace("{" + "index" + "}", getApiInvoker().escapeString(index));
        ...
        token.requestId = requestId;
        token.completionEventType = "rollback";

        token.returnType = RollbackStatus;
        return requestId;
     ...
     * Returns Base64NDArrayBody 
     */
    public function transformarray (deploymentName: String, versionName: String, transformName: String, batchRecord: BatchRecord): String {
        // create path and map variables
     ...
     * Returns Base64NDArrayBody 
     */
    public function transformincrementalarray (deploymentName: String, versionName: String, transformName: String, singleRecord: SingleRecord): String {
        // create path and map variables
     ...
     * Returns Object 
     */
    public function transformprocess_post (contentType: String, deploymentName: String, versionName: String, transformName: String, transformProcess: String): String {
        // create path and map variables
        var path: String = "/endpoints/{deploymentName}/datavec/{transformName}/{versionName}/transformprocess".replace(/{format}/g,"xml").replace("{" + "deploymentName" + "}", getApiInvoker().escapeString(deploymentName)).replace("{" + "versionName" + "}", getApiInvoker().escapeString(versionName)).replace("{" + "transformName" + "}", getApiInvoker().escapeString(transformName));
     ...
     * Returns AuthPolicy 
     */
    public function update_auth_policy (authPolicy: AuthPolicy): String {
        // create path and map variables
        var path: String = "/auth/policy".replace(/{format}/g,"xml");
        ...
        var token:AsyncToken = getApiInvoker().invokeAPI(path, "PUT", queryParams, authPolicy, headerParams);

        var requestId: String = getUniqueId();

        token.requestId = requestId;
        token.completionEventType = "update_auth_policy";
     ...
     * Returns User 
     */
    public function update_user (user: User): String {
        // create path and map variables
