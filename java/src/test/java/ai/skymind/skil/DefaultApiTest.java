...
public class DefaultApiTest {
    ...
    public void classifyTest() throws ApiException {
        ...
        ClassificationResult response = api.classify(deploymentName, versionName, modelName, body);
    ...
    public void classifyarrayTest() throws ApiException {
        ...
        String modelName = null;
        Prediction body = null;
        Base64NDArrayBody response = api.classifyarray(deploymentName, versionName, modelName, body);
    ...
    public void detectobjectsTest() throws ApiException {
        ...
        File file = null;
        DetectionResult response = api.detectobjects(deploymentName, versionName, modelName, id, needsPreprocessing, threshold, file);
    ...
    public void jsonarrayTest() throws ApiException {
        ...
        String modelName = null;
        Prediction body = null;
        JsonArrayResponse response = api.jsonarray(deploymentName, versionName, modelName, body);
    ...
    public void metaGetTest() throws ApiException {
        ...
        String versionName = null;
        String modelName = null;
        Object response = api.metaGet(deploymentName, versionName, modelName);
    ...
    public void metaPostTest() throws ApiException {
        ...
        String modelName = null;
        String body = null;
        Object response = api.metaPost(contentType, deploymentName, versionName, modelName, body);
    ...
    public void multiclassifyTest() throws ApiException {
        ...
        String modelName = null;
        Prediction body = null;
        MultiClassClassificationResult response = api.multiclassify(deploymentName, versionName, modelName, body);
    ...
    public void multipredictTest() throws ApiException {
        ...
        MultiPredictResponse response = api.multipredict(deploymentName, versionName, modelName, body);
    ...
    public void multipredictimageTest() throws ApiException {
        ...
        String id = null;
        Boolean needsPreprocessing = null;
        MultiPredictResponse response = api.multipredictimage(deploymentName, versionName, modelName, file, id, needsPreprocessing);
    ...
    public void predictTest() throws ApiException {
        ...
        String modelName = null;
        Prediction body = null;
        Prediction response = api.predict(deploymentName, versionName, modelName, body);
    ...
    public void predictwithpreprocessTest() throws ApiException {
        ...
        Prediction response = api.predictwithpreprocess(deploymentName, versionName, modelName, body);
    ...
    public void predictwithpreprocessjsonTest() throws ApiException {
        ...
        String modelName = null;
        List<String> body = null;
        JsonArrayResponse response = api.predictwithpreprocessjson(deploymentName, versionName, modelName, body);
