...
import ai.skymind.auth.OAuth;
import ai.skymind.auth.RetryingOAuth;
import ai.skymind.auth.OAuthFlow;

public class ApiClient {

    private String basePath = "http://localhost:9008";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://localhost:9008
