...
public class FileUploadList {
  public static final String SERIALIZED_NAME_FILE_UPLOAD_RESPONSE_LIST = "fileUploadResponseList";
  @SerializedName(SERIALIZED_NAME_FILE_UPLOAD_RESPONSE_LIST)
  private List<FileUpload> fileUploadResponseList = new ArrayList<FileUpload>();
