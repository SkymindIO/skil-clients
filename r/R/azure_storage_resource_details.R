...
AzureStorageResourceDetails <- R6::R6Class(
  ...
  public = list(
    ...
    `subType` = NULL,
    `containerName` = NULL,
    initialize = function(`@class`='io.skymind.resource.model.subtypes.storage.AzureStorageResourceDetails', `resourceId`=NULL, `type`=NULL, `subType`=NULL, `containerName`=NULL, ...){
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`@class`)) {
        AzureStorageResourceDetailsObject[['@class']] <-
          self$`@class`
      }
      if (!is.null(self$`resourceId`)) {
        AzureStorageResourceDetailsObject[['resourceId']] <-
          self$`resourceId`
      }
      if (!is.null(self$`type`)) {
        AzureStorageResourceDetailsObject[['type']] <-
          self$`type`
      }
      if (!is.null(self$`subType`)) {
        AzureStorageResourceDetailsObject[['subType']] <-
          self$`subType`
      }
      if (!is.null(self$`containerName`)) {
        AzureStorageResourceDetailsObject[['containerName']] <-
          self$`containerName`
      }
