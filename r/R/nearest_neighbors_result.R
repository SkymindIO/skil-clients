...
NearestNeighborsResult <- R6::R6Class(
  ...
  public = list(
    ...
    `distance` = NULL,
    `label` = NULL,
    initialize = function(`index`=NULL, `distance`=NULL, `label`=NULL, ...){
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`index`)) {
        NearestNeighborsResultObject[['index']] <-
          self$`index`
      }
      if (!is.null(self$`distance`)) {
        NearestNeighborsResultObject[['distance']] <-
          self$`distance`
      }
      if (!is.null(self$`label`)) {
        NearestNeighborsResultObject[['label']] <-
          self$`label`
      }
