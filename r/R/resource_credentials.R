...
ResourceCredentials <- R6::R6Class(
  ...
  public = list(
    ...
    `name` = NULL,
    `uri` = NULL,
    initialize = function(`credentialId`=NULL, `type`=NULL, `name`=NULL, `uri`=NULL, ...){
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`credentialId`)) {
        ResourceCredentialsObject[['credentialId']] <-
          self$`credentialId`
      }
      if (!is.null(self$`type`)) {
        ResourceCredentialsObject[['type']] <-
          self$`type`
      }
      if (!is.null(self$`name`)) {
        ResourceCredentialsObject[['name']] <-
          self$`name`
      }
      if (!is.null(self$`uri`)) {
        ResourceCredentialsObject[['uri']] <-
          self$`uri`
      }
