...
EvaluationResultsEntity <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`evaluation`=NULL, `evalName`=NULL, `modelInstanceId`=NULL, `created`=NULL, `f1`=NULL, `precision`=NULL, `recall`=NULL, `accuracy`=NULL, `rmse`=NULL, `auc`=NULL, `meanAbsoluteError`=NULL, `meanRelativeError`=NULL, `r2`=NULL, `evalId`=NULL, `evalVersion`=NULL, `binaryThreshold`=NULL, `binaryThresholds`=NULL, ...){
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`evaluation`)) {
        EvaluationResultsEntityObject[['evaluation']] <-
          self$`evaluation`
      }
      if (!is.null(self$`evalName`)) {
        EvaluationResultsEntityObject[['evalName']] <-
          self$`evalName`
      }
      if (!is.null(self$`modelInstanceId`)) {
        EvaluationResultsEntityObject[['modelInstanceId']] <-
          self$`modelInstanceId`
      }
      if (!is.null(self$`created`)) {
        EvaluationResultsEntityObject[['created']] <-
          self$`created`
      }
      if (!is.null(self$`f1`)) {
        EvaluationResultsEntityObject[['f1']] <-
          self$`f1`
      }
      if (!is.null(self$`precision`)) {
        EvaluationResultsEntityObject[['precision']] <-
          self$`precision`
      }
      if (!is.null(self$`recall`)) {
        EvaluationResultsEntityObject[['recall']] <-
          self$`recall`
      }
      if (!is.null(self$`accuracy`)) {
        EvaluationResultsEntityObject[['accuracy']] <-
          self$`accuracy`
      }
      if (!is.null(self$`rmse`)) {
        EvaluationResultsEntityObject[['rmse']] <-
          self$`rmse`
      }
      if (!is.null(self$`auc`)) {
        EvaluationResultsEntityObject[['auc']] <-
          self$`auc`
      }
      if (!is.null(self$`meanAbsoluteError`)) {
        EvaluationResultsEntityObject[['meanAbsoluteError']] <-
          self$`meanAbsoluteError`
      }
      if (!is.null(self$`meanRelativeError`)) {
        EvaluationResultsEntityObject[['meanRelativeError']] <-
          self$`meanRelativeError`
      }
      if (!is.null(self$`r2`)) {
        EvaluationResultsEntityObject[['r2']] <-
          self$`r2`
      }
      if (!is.null(self$`evalId`)) {
        EvaluationResultsEntityObject[['evalId']] <-
          self$`evalId`
      }
      if (!is.null(self$`evalVersion`)) {
        EvaluationResultsEntityObject[['evalVersion']] <-
          self$`evalVersion`
      }
      if (!is.null(self$`binaryThreshold`)) {
        EvaluationResultsEntityObject[['binaryThreshold']] <-
          self$`binaryThreshold`
      }
      if (!is.null(self$`binaryThresholds`)) {
        EvaluationResultsEntityObject[['binaryThresholds']] <-
