...
*SkilCient::DefaultApi* | [**create_job**](docs/DefaultApi.md#create_job) | **POST** /jobs/{jobtype} | Create a job
...
*SkilCient::DefaultApi* | [**delete_job_by_id**](docs/DefaultApi.md#delete_job_by_id) | **DELETE** /jobs/{jobId} | Deletes a job given its ID
...
*SkilCient::DefaultApi* | [**get_job_by_id**](docs/DefaultApi.md#get_job_by_id) | **GET** /jobs/{jobId} | Get a job by its ID
