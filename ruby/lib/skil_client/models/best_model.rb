...
module SkilCient
  class BestModel
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'columnNameMetric')
        self.column_name_metric = attributes[:'columnNameMetric']
      end

      if attributes.has_key?(:'evalType')
        self.eval_type = attributes[:'evalType']
      end
    end
