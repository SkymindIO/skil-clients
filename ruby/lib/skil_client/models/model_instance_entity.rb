  ...
  class ModelInstanceEntity
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SkilCient::ModelInstanceEntity` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SkilCient::ModelInstanceEntity`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'model_labels')
        self.model_labels = attributes[:'model_labels']
      end

      if attributes.key?(:'input_formats')
        self.input_formats = attributes[:'input_formats']
      end
      ...
      if attributes.key?(:'original_model_id')
        self.original_model_id = attributes[:'original_model_id']
      end
