...
module SkilCient
  class YARNResourceDetails
    ...
    attr_accessor :local_spark_home
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SkilCient::YARNResourceDetails` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SkilCient::YARNResourceDetails`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'local_spark_home')
        self.local_spark_home = attributes[:'local_spark_home']
      end
    end
    ...
    def valid?
      ...
      sub_type_validator = EnumAttributeValidator.new('String', ["YARN"])
    ...
    def sub_type=(sub_type)
      validator = EnumAttributeValidator.new('String', ["YARN"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          type == o.type &&
          sub_type == o.sub_type &&
          local_spark_home == o.local_spark_home
    end
