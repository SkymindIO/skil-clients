  ...
  class EMRResourceDetails
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SkilCient::EMRResourceDetails` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SkilCient::EMRResourceDetails`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'_class')
        ...
        self._class = 'io.skymind.resource.model.subtypes.compute.EMRResourceDetails'
      end
    ...
    def valid?
      ...
      sub_type_validator = EnumAttributeValidator.new('String', ["EMR"])
    ...
    def sub_type=(sub_type)
      validator = EnumAttributeValidator.new('String', ["EMR"])
    ...
    def hash
      [_class, resource_id, type, sub_type, cluster_id, region].hash
    end
