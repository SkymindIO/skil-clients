...
module SkilCient
  class AddResourceRequest
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'resourceDetails')
        self.resource_details = attributes[:'resourceDetails']
      end

      if attributes.has_key?(:'credentialUri')
        self.credential_uri = attributes[:'credentialUri']
      end
