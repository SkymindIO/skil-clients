  ...
  class AddResourceRequest
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SkilCient::AddResourceRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SkilCient::AddResourceRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'credential_uri')
        self.credential_uri = attributes[:'credential_uri']
      end
    ...
    def valid?
      type_validator = EnumAttributeValidator.new('String', ["COMPUTE", "STORAGE"])
      return false unless type_validator.valid?(@type)
      sub_type_validator = EnumAttributeValidator.new('String', ["EMR", "S3", "GoogleStorage", "DataProc", "HDInsight", "AzureStorage", "HDFS", "YARN"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["COMPUTE", "STORAGE"])
    ...
    def sub_type=(sub_type)
      validator = EnumAttributeValidator.new('String', ["EMR", "S3", "GoogleStorage", "DataProc", "HDInsight", "AzureStorage", "HDFS", "YARN"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          credential_uri == o.credential_uri &&
          type == o.type &&
          sub_type == o.sub_type &&
    ...
    def hash
      [resource_name, resource_details, credential_uri, type, sub_type, credential_id].hash
    end
