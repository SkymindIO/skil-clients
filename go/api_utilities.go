...
/* 
UtilitiesApiService Upload a model file to SKIL for import.
...
func (a *UtilitiesApiService) Upload(ctx context.Context, localVarOptionals *UploadOpts) (FileUploadList, *http.Response, error) {
	var (
