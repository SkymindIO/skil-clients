...
*/
func (a *DefaultApiService) AddResource(ctx context.Context, addResourceRequest AddResourceRequest) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHttpMethod   = http.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (a *DefaultApiService) Classify(ctx context.Context, deploymentName string, versionName string, modelName string, body Prediction) (ClassificationResult, *http.Response, error) {
	var (
		localVarHttpMethod   = http.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (a *DefaultApiService) Classifyarray(ctx context.Context, deploymentName string, versionName string, modelName string, body Prediction) (Base64NdArrayBody, *http.Response, error) {
	var (
		localVarHttpMethod   = http.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (a *DefaultApiService) Detectobjects(ctx context.Context, deploymentName string, versionName string, modelName string, id string, needsPreprocessing bool, threshold float32, file *os.File) (DetectionResult, *http.Response, error) {
	var (
		localVarHttpMethod   = http.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
/*
DefaultApiService Get model details
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param deploymentId ID deployment group
 * @param modelId the id of the deployed model
@return ModelEntity
*/
func (a *DefaultApiService) GetModelDetails(ctx context.Context, deploymentId string, modelId string) (ModelEntity, *http.Response, error) {
	var (
		localVarHttpMethod   = http.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
@return map[string]interface{}
*/
func (a *DefaultApiService) GetResourceDetailsById(ctx context.Context, resourceId int64) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHttpMethod   = http.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (a *DefaultApiService) Jsonarray(ctx context.Context, deploymentName string, versionName string, modelName string, body Prediction) (JsonArrayResponse, *http.Response, error) {
	var (
		localVarHttpMethod   = http.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
@return map[string]interface{}
*/
func (a *DefaultApiService) MetaGet(ctx context.Context, deploymentName string, versionName string, modelName string) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHttpMethod   = http.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
@return map[string]interface{}
*/
func (a *DefaultApiService) MetaPost(ctx context.Context, contentType string, deploymentName string, versionName string, modelName string, body string) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHttpMethod   = http.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
@return ModelStatus
*/
func (a *DefaultApiService) Modelupdate(ctx context.Context, deploymentName string, versionName string, modelName string, file *os.File) (ModelStatus, *http.Response, error) {
	var (
		localVarHttpMethod   = http.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (a *DefaultApiService) Multiclassify(ctx context.Context, deploymentName string, versionName string, modelName string, body Prediction) (MultiClassClassificationResult, *http.Response, error) {
	var (
		localVarHttpMethod   = http.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (a *DefaultApiService) Multipredict(ctx context.Context, deploymentName string, versionName string, modelName string, body MultiPredictRequest) (MultiPredictResponse, *http.Response, error) {
	var (
		localVarHttpMethod   = http.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
@return MultiPredictResponse
*/
func (a *DefaultApiService) Multipredictimage(ctx context.Context, deploymentName string, versionName string, modelName string, file *os.File, id string, needsPreprocessing bool) (MultiPredictResponse, *http.Response, error) {
	var (
		localVarHttpMethod   = http.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
@return Prediction
*/
func (a *DefaultApiService) Predict(ctx context.Context, deploymentName string, versionName string, modelName string, body Prediction) (Prediction, *http.Response, error) {
	var (
		localVarHttpMethod   = http.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (a *DefaultApiService) PredictV2File(ctx context.Context, operation string, inputTypeFile string, inputData *os.File) (*http.Response, error) {
	...
	localVarFormFileName = "inputData"
	localVarFile := inputData
	if localVarFile != nil {
		fbs, _ := ioutil.ReadAll(localVarFile)
		localVarFileBytes = fbs
		localVarFileName = localVarFile.Name()
...
@return Prediction
*/
func (a *DefaultApiService) Predictwithpreprocess(ctx context.Context, deploymentName string, versionName string, modelName string, body []string) (Prediction, *http.Response, error) {
	var (
		localVarHttpMethod   = http.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
@return JsonArrayResponse
*/
func (a *DefaultApiService) Predictwithpreprocessjson(ctx context.Context, deploymentName string, versionName string, modelName string, body []string) (JsonArrayResponse, *http.Response, error) {
	var (
		localVarHttpMethod   = http.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
@return Base64NdArrayBody
*/
func (a *DefaultApiService) Transformimage(ctx context.Context, deploymentName string, versionName string, imageTransformName string, files []*os.File) (Base64NdArrayBody, *http.Response, error) {
	var (
		localVarHttpMethod   = http.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
@return map[string]interface{}
*/
func (a *DefaultApiService) TransformprocessGet(ctx context.Context, deploymentName string, versionName string, transformName string) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHttpMethod   = http.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (a *DefaultApiService) TransformprocessPost(ctx context.Context, contentType string, deploymentName string, versionName string, transformName string, localVarOptionals *TransformprocessPostOpts) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHttpMethod   = http.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
