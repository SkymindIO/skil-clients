...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SkilClient.AggregatePrediction();
  });
  ...
  describe('AggregatePrediction', function() {
    it('should create an instance of AggregatePrediction', function() {
      // uncomment below and update the code to test AggregatePrediction
      //var instance = new SkilClient.AggregatePrediction();
      //expect(instance).to.be.a(SkilClient.AggregatePrediction);
    });
