...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SkilClient.ChangePasswordRequest();
  });
  ...
  describe('ChangePasswordRequest', function() {
    it('should create an instance of ChangePasswordRequest', function() {
      ...
      //var instance = new SkilClient.ChangePasswordRequest();
      //expect(instance).to.be.a(SkilClient.ChangePasswordRequest);
    });
