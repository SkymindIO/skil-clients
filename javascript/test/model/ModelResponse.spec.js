...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SkilClient.ModelResponse();
  });
  ...
  describe('ModelResponse', function() {
    it('should create an instance of ModelResponse', function() {
      // uncomment below and update the code to test ModelResponse
      //var instance = new SkilClient.ModelResponse();
      //expect(instance).to.be.a(SkilClient.ModelResponse);
    });
