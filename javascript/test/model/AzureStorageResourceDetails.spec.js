...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SkilClient.AzureStorageResourceDetails();
  });
  ...
  describe('AzureStorageResourceDetails', function() {
    it('should create an instance of AzureStorageResourceDetails', function() {
      // uncomment below and update the code to test AzureStorageResourceDetails
      //var instance = new SkilClient.AzureStorageResourceDetails();
      //expect(instance).to.be.a(SkilClient.AzureStorageResourceDetails);
    });
