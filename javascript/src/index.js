...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'ai/skymind/skil/model/AddCredentialsRequest', 'ai/skymind/skil/model/AddExampleRequest', 'ai/skymind/skil/model/AddModelHistoryRequest', 'ai/skymind/skil/model/AddResourceRequest', 'ai/skymind/skil/model/AggregatePrediction', 'ai/skymind/skil/model/AzureStorageResourceDetails', 'ai/skymind/skil/model/Base64NDArrayBody', 'ai/skymind/skil/model/Base64NDArrayBodyKNN', 'ai/skymind/skil/model/BatchCSVRecord', 'ai/skymind/skil/model/BatchImageRecord', 'ai/skymind/skil/model/BestModel', 'ai/skymind/skil/model/ClassificationResult', 'ai/skymind/skil/model/CreateDeploymentRequest', 'ai/skymind/skil/model/CreateJobRequest', 'ai/skymind/skil/model/Credentials', 'ai/skymind/skil/model/DataProcResourceDetails', 'ai/skymind/skil/model/DeploymentObjects', 'ai/skymind/skil/model/DeploymentResponse', 'ai/skymind/skil/model/DetectedObject', 'ai/skymind/skil/model/DetectionResult', 'ai/skymind/skil/model/DownloadOutputFileRequest', 'ai/skymind/skil/model/EMRResourceDetails', 'ai/skymind/skil/model/EvaluationResultsEntity', 'ai/skymind/skil/model/ExampleEntity', 'ai/skymind/skil/model/ExperimentEntity', 'ai/skymind/skil/model/FileUpload', 'ai/skymind/skil/model/FileUploadList', 'ai/skymind/skil/model/GoogleStorageResourceDetails', 'ai/skymind/skil/model/HDFSResourceDetails', 'ai/skymind/skil/model/HDInsightResourceDetails', 'ai/skymind/skil/model/INDArray', 'ai/skymind/skil/model/ImageTransformProcess', 'ai/skymind/skil/model/ImportModelRequest', 'ai/skymind/skil/model/InlineResponse200', 'ai/skymind/skil/model/JobEntity', 'ai/skymind/skil/model/JsonArrayResponse', 'ai/skymind/skil/model/LogBatch', 'ai/skymind/skil/model/LogRequest', 'ai/skymind/skil/model/MetaData', 'ai/skymind/skil/model/MinibatchEntity', 'ai/skymind/skil/model/ModelEntity', 'ai/skymind/skil/model/ModelFeedBackRequest', 'ai/skymind/skil/model/ModelHistoryEntity', 'ai/skymind/skil/model/ModelInstanceEntity', 'ai/skymind/skil/model/ModelResponse', 'ai/skymind/skil/model/ModelStatus', 'ai/skymind/skil/model/MultiClassClassificationResult', 'ai/skymind/skil/model/MultiPredictRequest', 'ai/skymind/skil/model/MultiPredictResponse', 'ai/skymind/skil/model/NearestNeighborRequest', 'ai/skymind/skil/model/NearestNeighborsResult', 'ai/skymind/skil/model/NearestNeighborsResults', 'ai/skymind/skil/model/NewDeployment', 'ai/skymind/skil/model/Prediction', 'ai/skymind/skil/model/Resource', 'ai/skymind/skil/model/ResourceCredentials', 'ai/skymind/skil/model/ResourceGroup', 'ai/skymind/skil/model/S3ResourceDetails', 'ai/skymind/skil/model/SetState', 'ai/skymind/skil/model/SingleCSVRecord', 'ai/skymind/skil/model/SingleImageRecord', 'ai/skymind/skil/model/Token', 'ai/skymind/skil/model/TransformProcess', 'ai/skymind/skil/model/UpdateBestModel', 'ai/skymind/skil/model/YARNResourceDetails', 'ai/skymind/skil/AuthenticationApi', 'ai/skymind/skil/DeploymentApi', 'ai/skymind/skil/InferenceApi', 'ai/skymind/skil/JobApi', 'ai/skymind/skil/KNNApi', 'ai/skymind/skil/ModelHistoryApi', 'ai/skymind/skil/ResourceApi', 'ai/skymind/skil/TransformApi', 'ai/skymind/skil/UtilitiesApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./ai/skymind/skil/model/AddCredentialsRequest'), require('./ai/skymind/skil/model/AddExampleRequest'), require('./ai/skymind/skil/model/AddModelHistoryRequest'), require('./ai/skymind/skil/model/AddResourceRequest'), require('./ai/skymind/skil/model/AggregatePrediction'), require('./ai/skymind/skil/model/AzureStorageResourceDetails'), require('./ai/skymind/skil/model/Base64NDArrayBody'), require('./ai/skymind/skil/model/Base64NDArrayBodyKNN'), require('./ai/skymind/skil/model/BatchCSVRecord'), require('./ai/skymind/skil/model/BatchImageRecord'), require('./ai/skymind/skil/model/BestModel'), require('./ai/skymind/skil/model/ClassificationResult'), require('./ai/skymind/skil/model/CreateDeploymentRequest'), require('./ai/skymind/skil/model/CreateJobRequest'), require('./ai/skymind/skil/model/Credentials'), require('./ai/skymind/skil/model/DataProcResourceDetails'), require('./ai/skymind/skil/model/DeploymentObjects'), require('./ai/skymind/skil/model/DeploymentResponse'), require('./ai/skymind/skil/model/DetectedObject'), require('./ai/skymind/skil/model/DetectionResult'), require('./ai/skymind/skil/model/DownloadOutputFileRequest'), require('./ai/skymind/skil/model/EMRResourceDetails'), require('./ai/skymind/skil/model/EvaluationResultsEntity'), require('./ai/skymind/skil/model/ExampleEntity'), require('./ai/skymind/skil/model/ExperimentEntity'), require('./ai/skymind/skil/model/FileUpload'), require('./ai/skymind/skil/model/FileUploadList'), require('./ai/skymind/skil/model/GoogleStorageResourceDetails'), require('./ai/skymind/skil/model/HDFSResourceDetails'), require('./ai/skymind/skil/model/HDInsightResourceDetails'), require('./ai/skymind/skil/model/INDArray'), require('./ai/skymind/skil/model/ImageTransformProcess'), require('./ai/skymind/skil/model/ImportModelRequest'), require('./ai/skymind/skil/model/InlineResponse200'), require('./ai/skymind/skil/model/JobEntity'), require('./ai/skymind/skil/model/JsonArrayResponse'), require('./ai/skymind/skil/model/LogBatch'), require('./ai/skymind/skil/model/LogRequest'), require('./ai/skymind/skil/model/MetaData'), require('./ai/skymind/skil/model/MinibatchEntity'), require('./ai/skymind/skil/model/ModelEntity'), require('./ai/skymind/skil/model/ModelFeedBackRequest'), require('./ai/skymind/skil/model/ModelHistoryEntity'), require('./ai/skymind/skil/model/ModelInstanceEntity'), require('./ai/skymind/skil/model/ModelResponse'), require('./ai/skymind/skil/model/ModelStatus'), require('./ai/skymind/skil/model/MultiClassClassificationResult'), require('./ai/skymind/skil/model/MultiPredictRequest'), require('./ai/skymind/skil/model/MultiPredictResponse'), require('./ai/skymind/skil/model/NearestNeighborRequest'), require('./ai/skymind/skil/model/NearestNeighborsResult'), require('./ai/skymind/skil/model/NearestNeighborsResults'), require('./ai/skymind/skil/model/NewDeployment'), require('./ai/skymind/skil/model/Prediction'), require('./ai/skymind/skil/model/Resource'), require('./ai/skymind/skil/model/ResourceCredentials'), require('./ai/skymind/skil/model/ResourceGroup'), require('./ai/skymind/skil/model/S3ResourceDetails'), require('./ai/skymind/skil/model/SetState'), require('./ai/skymind/skil/model/SingleCSVRecord'), require('./ai/skymind/skil/model/SingleImageRecord'), require('./ai/skymind/skil/model/Token'), require('./ai/skymind/skil/model/TransformProcess'), require('./ai/skymind/skil/model/UpdateBestModel'), require('./ai/skymind/skil/model/YARNResourceDetails'), require('./ai/skymind/skil/AuthenticationApi'), require('./ai/skymind/skil/DeploymentApi'), require('./ai/skymind/skil/InferenceApi'), require('./ai/skymind/skil/JobApi'), require('./ai/skymind/skil/KNNApi'), require('./ai/skymind/skil/ModelHistoryApi'), require('./ai/skymind/skil/ResourceApi'), require('./ai/skymind/skil/TransformApi'), require('./ai/skymind/skil/UtilitiesApi'));
  }
}(function(ApiClient, AddCredentialsRequest, AddExampleRequest, AddModelHistoryRequest, AddResourceRequest, AggregatePrediction, AzureStorageResourceDetails, Base64NDArrayBody, Base64NDArrayBodyKNN, BatchCSVRecord, BatchImageRecord, BestModel, ClassificationResult, CreateDeploymentRequest, CreateJobRequest, Credentials, DataProcResourceDetails, DeploymentObjects, DeploymentResponse, DetectedObject, DetectionResult, DownloadOutputFileRequest, EMRResourceDetails, EvaluationResultsEntity, ExampleEntity, ExperimentEntity, FileUpload, FileUploadList, GoogleStorageResourceDetails, HDFSResourceDetails, HDInsightResourceDetails, INDArray, ImageTransformProcess, ImportModelRequest, InlineResponse200, JobEntity, JsonArrayResponse, LogBatch, LogRequest, MetaData, MinibatchEntity, ModelEntity, ModelFeedBackRequest, ModelHistoryEntity, ModelInstanceEntity, ModelResponse, ModelStatus, MultiClassClassificationResult, MultiPredictRequest, MultiPredictResponse, NearestNeighborRequest, NearestNeighborsResult, NearestNeighborsResults, NewDeployment, Prediction, Resource, ResourceCredentials, ResourceGroup, S3ResourceDetails, SetState, SingleCSVRecord, SingleImageRecord, Token, TransformProcess, UpdateBestModel, YARNResourceDetails, AuthenticationApi, DeploymentApi, InferenceApi, JobApi, KNNApi, ModelHistoryApi, ResourceApi, TransformApi, UtilitiesApi) {
  'use strict';
  ...
  var exports = {
     ...
     * @property {module:ai/skymind/skil/AuthenticationApi}
     */
    AuthenticationApi: AuthenticationApi,
    /**
     * The DeploymentApi service constructor.
     * @property {module:ai/skymind/skil/DeploymentApi}
     */
    DeploymentApi: DeploymentApi,
    /**
     * The InferenceApi service constructor.
     * @property {module:ai/skymind/skil/InferenceApi}
     */
    InferenceApi: InferenceApi,
    /**
     * The JobApi service constructor.
     * @property {module:ai/skymind/skil/JobApi}
     */
    JobApi: JobApi,
    /**
     * The KNNApi service constructor.
     * @property {module:ai/skymind/skil/KNNApi}
     */
    KNNApi: KNNApi,
    /**
     * The ModelHistoryApi service constructor.
     * @property {module:ai/skymind/skil/ModelHistoryApi}
     */
    ModelHistoryApi: ModelHistoryApi,
    /**
     * The ResourceApi service constructor.
     * @property {module:ai/skymind/skil/ResourceApi}
     */
    ResourceApi: ResourceApi,
    /**
     * The TransformApi service constructor.
     * @property {module:ai/skymind/skil/TransformApi}
     */
    TransformApi: TransformApi,
    /**
     * The UtilitiesApi service constructor.
     * @property {module:ai/skymind/skil/UtilitiesApi}
     */
