...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'ai/skymind/skil/model/SingleRecord'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./SingleRecord'));
  } else {
    // Browser globals (root is window)
    if (!root.SkilClient) {
      root.SkilClient = {};
    }
    root.SkilClient.BatchRecord = factory(root.SkilClient.ApiClient, root.SkilClient.SingleRecord);
  }
}(this, function(ApiClient, SingleRecord) {
  'use strict';
