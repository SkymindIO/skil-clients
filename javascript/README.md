...
*SkilClient.DefaultApi* | [**createJob**](docs/DefaultApi.md#createJob) | **POST** /jobs/{jobtype} | Create a job
...
*SkilClient.DefaultApi* | [**deleteJobById**](docs/DefaultApi.md#deleteJobById) | **DELETE** /jobs/{jobId} | Deletes a job given its ID
...
*SkilClient.DefaultApi* | [**getJobById**](docs/DefaultApi.md#getJobById) | **GET** /jobs/{jobId} | Get a job by its ID
