...
To use the link you just defined in your project, switch to the directory you want to use your skil-client from, and run:
...
var x_api_key = defaultClient.authentications['x_api_key'];
x_api_key.apiKey = "YOUR API KEY"
// Uncomment the following line to set a prefix for the API key, e.g. "Token" (defaults to null)
//x_api_key.apiKeyPrefix['X-API-Key'] = "Token"
