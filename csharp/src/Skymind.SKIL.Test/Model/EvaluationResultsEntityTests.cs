...
namespace Skymind.SKIL.Test
{
    ...
    public class EvaluationResultsEntityTests
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOfType" EvaluationResultsEntity
            //Assert.IsInstanceOfType<EvaluationResultsEntity> (instance, "variable 'instance' is a EvaluationResultsEntity");
        }
