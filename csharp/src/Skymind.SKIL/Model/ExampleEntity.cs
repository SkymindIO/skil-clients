...
namespace Skymind.SKIL.Model
{
    ...
    public partial class ExampleEntity :  IEquatable<ExampleEntity>, IValidatableObject
    {
        ...
        [DataMember(Name="int rowNumber", EmitDefaultValue=false)]
        ...
        public bool Equals(ExampleEntity input)
        {
            ...
            return 
                ...
                (
                    this.IntRowNumber == input.IntRowNumber ||
                    (this.IntRowNumber != null &&
                    this.IntRowNumber.Equals(input.IntRowNumber))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.IntRowNumber != null)
                    hashCode = hashCode * 59 + this.IntRowNumber.GetHashCode();
