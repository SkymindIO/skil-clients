...
namespace Skymind.SKIL.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SingleImageRecord :  IEquatable<SingleImageRecord>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SingleImageRecord" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SingleImageRecord() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SingleImageRecord" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as SingleImageRecord);
        }

        /// <summary>
        /// Returns true if SingleImageRecord instances are equal
        /// </summary>
        /// <param name="input">Instance of SingleImageRecord to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SingleImageRecord input)
        {
            if (input == null)
                return false;
