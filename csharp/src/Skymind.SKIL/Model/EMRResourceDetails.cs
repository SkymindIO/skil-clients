...
namespace Skymind.SKIL.Model
{
    ...
    public partial class EMRResourceDetails :  IEquatable<EMRResourceDetails>, IValidatableObject
    {
        ...
        public EMRResourceDetails(long? resourceId = default(long?), TypeEnum? type = default(TypeEnum?), SubTypeEnum? subType = default(SubTypeEnum?), string clusterId = default(string), string region = default(string))
        {
