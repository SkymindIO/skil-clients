...
${nuget_cmd} install src/Skymind.SKIL/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/Skymind.SKIL.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/Skymind.SKIL.dll \
-recurse:'src/Skymind.SKIL/*.cs' \
-doc:bin/Skymind.SKIL.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/Skymind.SKIL.dll was created successfully"
fi
