...
${nuget_cmd} install src/Skymind.Skil.Client/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/Skymind.Skil.Client.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/Skymind.Skil.Client.dll \
-recurse:'src/Skymind.Skil.Client/*.cs' \
-doc:bin/Skymind.Skil.Client.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/Skymind.Skil.Client.dll was created successfully"
fi
