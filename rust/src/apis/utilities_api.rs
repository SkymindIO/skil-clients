...
pub struct UtilitiesApiClient<C: hyper::client::Connect> {
    configuration: Rc<configuration::Configuration<C>>,
}

impl<C: hyper::client::Connect> UtilitiesApiClient<C> {
    pub fn new(configuration: Rc<configuration::Configuration<C>>) -> UtilitiesApiClient<C> {
        UtilitiesApiClient {
