...
pub struct ExampleEntity {
  ...
  /// Row Number
  #[serde(rename = "int rowNumber")]
  int_row_number: Option<i32>,
...
impl ExampleEntity {
  ...
  pub fn set_int_row_number(&mut self, int_row_number: i32) {
    self.int_row_number = Some(int_row_number);
  }

  pub fn with_int_row_number(mut self, int_row_number: i32) -> ExampleEntity {
    self.int_row_number = Some(int_row_number);
    self
  }

  pub fn int_row_number(&self) -> Option<&i32> {
    self.int_row_number.as_ref()
  }

  pub fn reset_int_row_number(&mut self) {
    self.int_row_number = None;
  }
