...
api_instance = skil_client.DefaultApi(skil_client.ApiClient(configuration))
id = 'id_example' # str | Batch ID to retrain the model with and get feedback for.
labels = NULL # list[list[float]] | The associated labels (one-hot vectors) with the batch for retraining. (optional)
...
input = NULL # list[str] | Input indices array (optional)
 ...
 **input** | [**list[str]**](list.md)| Input indices array | [optional] 
...
# **logs**
> LogBatch logs(deployment_name, version_name, model_name, body)
...
try:
    # Get logs
    api_response = api_instance.logs(deployment_name, version_name, model_name, body)
    pprint(api_response)
except ApiException as e:
...
# **meta_post**
> object meta_post(deployment_name, version_name, model_name, body)
...
try:
    # This method can be used to set meta data for the current model which is set to the server
    api_response = api_instance.meta_post(deployment_name, version_name, model_name, body)
    pprint(api_response)
except ApiException as e:
...
input_data = NULL # list[str] |  (optional)
 ...
 **input_data** | [**list[str]**](list.md)|  | [optional] 
...
input_data = skil_client.UNKNOWN_BASE_TYPE() # UNKNOWN_BASE_TYPE |  (optional)
 ...
 **input_data** | [**UNKNOWN_BASE_TYPE**](UNKNOWN_BASE_TYPE.md)|  | [optional] 
...
version_name = 'default' # str | Version name of the endpoint. The default value is \"default\" (default to 'default')
model_name = 'model_name_example' # str | ID or name of the deployed model
body = NULL # list[str] | The input array
 ...
 **version_name** | **str**| Version name of the endpoint. The default value is \&quot;default\&quot; | [default to &#39;default&#39;]
 **model_name** | **str**| ID or name of the deployed model | 
 **body** | [**list[str]**](list.md)| The input array | 
...
version_name = 'default' # str | Version name of the endpoint. The default value is \"default\" (default to 'default')
transform_name = 'transform_name_example' # str | ID or name of the deployed transform
batch_record = skil_client.UNKNOWN_BASE_TYPE() # UNKNOWN_BASE_TYPE | The input batch of record arrays (optional)
 ...
 **version_name** | **str**| Version name of the endpoint. The default value is \&quot;default\&quot; | [default to &#39;default&#39;]
 **transform_name** | **str**| ID or name of the deployed transform | 
 **batch_record** | [**UNKNOWN_BASE_TYPE**](UNKNOWN_BASE_TYPE.md)| The input batch of record arrays | [optional] 
...
version_name = 'default' # str | Version name of the endpoint. The default value is \"default\" (default to 'default')
transform_name = 'transform_name_example' # str | ID or name of the deployed transform
single_record = skil_client.UNKNOWN_BASE_TYPE() # UNKNOWN_BASE_TYPE | The input record array (optional)
 ...
 **version_name** | **str**| Version name of the endpoint. The default value is \&quot;default\&quot; | [default to &#39;default&#39;]
 **transform_name** | **str**| ID or name of the deployed transform | 
 **single_record** | [**UNKNOWN_BASE_TYPE**](UNKNOWN_BASE_TYPE.md)| The input record array | [optional] 
...
version_name = 'default' # str | Version name of the endpoint. The default value is \"default\" (default to 'default')
transform_name = 'transform_name_example' # str | ID or name of the deployed transform
transform_process = skil_client.UNKNOWN_BASE_TYPE() # UNKNOWN_BASE_TYPE | The transform process to set (optional)
 ...
 **version_name** | **str**| Version name of the endpoint. The default value is \&quot;default\&quot; | [default to &#39;default&#39;]
 **transform_name** | **str**| ID or name of the deployed transform | 
 **transform_process** | [**UNKNOWN_BASE_TYPE**](UNKNOWN_BASE_TYPE.md)| The transform process to set | [optional] 
