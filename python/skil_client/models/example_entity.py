...
class ExampleEntity(object):
    ...
    def __init__(self, example_id=None, example_version=None, int_row_number=None, created=None, mini_batch_id=None, mini_batch_version=None):  # noqa: E501
        """ExampleEntity - a model defined in Swagger"""  # noqa: E501

        self._example_id = None
        self._example_version = None
        self._int_row_number = None
        self._created = None
        ...
        if int_row_number is not None:
            self.int_row_number = int_row_number
    ...
    @property
    def int_row_number(self):
        """Gets the int_row_number of this ExampleEntity.  # noqa: E501

        Row Number  # noqa: E501

        :return: The int_row_number of this ExampleEntity.  # noqa: E501
        :rtype: int
        """
        return self._int_row_number

    @int_row_number.setter
    def int_row_number(self, int_row_number):
        """Sets the int_row_number of this ExampleEntity.

        Row Number  # noqa: E501

        :param int_row_number: The int_row_number of this ExampleEntity.  # noqa: E501
        :type: int
        """

        self._int_row_number = int_row_number
